var jison,fs,isinstance,regexp,isundefined,Node,If,Suite,Dict,List,Comprehension,Literal,Expression,Power,Ternary,Index,Property,Invocation,For,Assign,Augment,Import,Assert,While,Try,Lambda,Func,Class,Module,bif_callable,bif_bytes,bif_bytearray,bif_bool,bif_ascii,bif_bin,bif_basestring,bif_print,bif_abs,bif_all,bif_any,bnf,rules,identifier,operator,newline,startline,dedent,keywords,operators,operators,macros,grammar,scope,parser,fname,source,out;
jison=require("jison");
fs=require("fs");
...
Node = (function(){
    ...
    getvars = function() {
        var __pyi1, __pyarr2, __pyi3, __pyarr4, child, child, __pyi5, __pyarr6, __pyi1, __pyarr2, __pyi3, __pyarr4, child, __pyi5, __pyarr6;
        vars_=[];
    ...
    toString = function() {
        var out, __pyi7, __pyarr8, out, out, __pyi7, __pyarr8;
        out="";
...
If = (function(){
    ...
    toString = function() {
        var out, __pyi9, __pyarr10, out, __pyi9, __pyarr10;
        out="if ("+this.cond+") {\n";
...
Suite = (function(){
    var Suite,toString;
    toString = function() {
        var out, __pyi11, __pyarr12, v, out, out, __pyi11, __pyarr12, v;
        out=[];
        __pyarr12=this.v;
...
Dict = (function(){
    var Dict,toString;
    toString = function() {
        var target, out, out, __pyi13, __pyarr14, target, out, __pyi13, __pyarr14;
...
List = (function(){
    var List,toString;
    toString = function() {
        var target, out, out, out, out, __pyi15, __pyarr16, out, target, out, __pyi15, __pyarr16;
...
Expression = (function(){
    ...
    toString = function() {
        var out, __pyi17, __pyarr18, out, out, out, out, __pyi17, __pyarr18;
        out="";
        __pyarr18=this.v;
...
Invocation = (function(){
    ...
    toString = function() {
        var items, __pyi19, __pyarr20, items, __pyi19, __pyarr20;
        items=[];
        __pyarr20=this.v;
...
For = (function(){
    ...
    toString = function() {
        var i, arr, code, out, out, out, out, i, arr, code, out;
        i=this.allocate("i");
...
Assign = (function(){
    ...
    toString = function() {
        var unpack, out, i, __pyi21, __pyarr22, first, out, __pyi23, __pyarr24, i, __pyi25, __pyarr26, __pyi27, __pyarr28, unpack, out, i, __pyi21, __pyarr22, first, __pyi23, __pyarr24, __pyi25, __pyarr26, __pyi27, __pyarr28;
        unpack=[];
        out=[];
        i=0;
        __pyarr22=this.v;
        ...
        vars_=[].concat(out.slice(0, -1));
        console.log( 1, vars_ )
        out.toString()
        // out[0].toString()
        // out[1].toString()
        console.log( 2, vars_.length )
        first=out[0];
        // out.join( "=" )
        var abc = out.join("=")
        out=[abc];
...
Import = (function(){
    ...
    toString = function() {
        var out, base, dots, dots, base, up, __pyi29, __pyarr30, name, path, out, base, dots, up, __pyi29, __pyarr30, name, path;
        this.vars_=[];
        out=[];
        base=[];
        if (this.from_) {
...
While = (function(){
    ...
    toString = function() {
        var code, cond, code, cond, code, out, code, cond, out;
        code=this.code.toString();
        cond=this.cond;
        if (this.else_) {
...
Try = (function(){
    ...
    toString = function() {
        var out, elifs, __pyi31, __pyarr32, out, out, out, out, out, out, elifs, __pyi31, __pyarr32;
...
Lambda = (function(){
    var Lambda,__init__,getvars,toString;
    __init__ = function(params, code) {
        this.params=params;
        this.code=code
    };
    getvars = function() {
    ...
    toString = function() {
        var code, params, i, __pyi33, __pyarr34, name, code, code, seen, nodes, __pyi35, __pyarr36, code, code, params, code, params, i, __pyi33, __pyarr34, name, seen, nodes, __pyi35, __pyarr36;
        this.vars_=[];
        code="return "+this.code;
        params=[];
        i=0;
        __pyarr34=this.params;
        (Array.isArray(__pyarr34)||(__pyarr34=Object.keys(__pyarr34)));
        for (__pyi33=0;__pyi33<__pyarr34.length;__pyi33+=1){
            param=__pyarr34[__pyi33];
    ...
    Lambda.prototype = Object.create(Node.prototype);
    Lambda.prototype.__init__ = __init__;
    Lambda.prototype.getvars = getvars;
    Lambda.prototype.toString = toString;
    return Lambda
})();
Func = (function(){
    ...
    toString = function() {
        var code, params, i, __pyi37, __pyarr38, name, code, code, seen, nodes, __pyi39, __pyarr40, code, code, params, code, params, i, __pyi37, __pyarr38, name, seen, nodes, __pyi39, __pyarr40;
        this.vars_=[];
        code=this.code.toString();
        params=[];
        i=0;
...
Class = (function(){
    ...
    toString = function() {
        var name, code, ctor, parent, __pyi41, __pyarr42, nvars, nvars, code, name, code, ctor, parent, __pyi41, __pyarr42, nvars;
        name=this.name;
        code=this.code+";\n";
...
Module = (function(){
    var Module,toString;
    toString = function() {
        var out, __pyi43, __pyarr44, v, __pyi45, __pyarr46, out, out, __pyi43, __pyarr44, v, __pyi45, __pyarr46;
        out=[];
        vars_=[];
        __pyarr44=this.v;
        (Array.isArray(__pyarr44)||(__pyarr44=Object.keys(__pyarr44)));
        for (__pyi43=0;__pyi43<__pyarr44.length;__pyi43+=1){
            item=__pyarr44[__pyi43];
            v=item.toString().trim();
            if (v) {
                out.push(v)
            }
        ...
        __pyarr46=vars_;
        (Array.isArray(__pyarr46)||(__pyarr46=Object.keys(__pyarr46)));
        for (__pyi45=0;__pyi45<__pyarr46.length;__pyi45+=1){
            var_=__pyarr46[__pyi45];
...
bif_callable = function(o) {
    return eval("typeof o == \"function\"")
};
bif_bytes = function(src, encoding) {
    return bytearray(src,encoding)
};
bif_bytearray = function(src, encoding) {
    return eval("new Buffer(src,encoding)")
};
bif_bool = function(v) {
    return Boolean(v)
};
bif_ascii = function(o) {
    return o.toString()
};
bif_bin = function(x) {
    return Number(x).toString(2)
};
bif_basestring = function(s) {
    return String(s)
};
bif_print = function(msg) {
    console.log(msg)
};
bif_abs = function(n) {
    return Math.abs(n)
};
bif_all = function(iter_) {
    var is_true, is_true;
    is_true = function(i) {
        return i==true
    };
...
operator = function(yy, yytext) {
    var openers, closers, openers, closers;
    openers=["(", "{", "["];
    closers=[")", "}", "]"];
...
_bifs=["abs", "divmod", "input", "open", "staticmethod", "all", "enumerate", "int", "ord", "str", "any", "eval", "isinstance", "pow", "sum", "basestring", "execfile", "issubclass", "print", "super", "bin", "file", "iter", "property", "tuple", "bool", "filter", "len", "range", "type", "bytearray", "float", "list", "raw_input", "unichr", "callable", "format", "locals", "reduce", "unicode", "chr", "frozenset", "long", "reload", "vars", "classmethod", "getattr", "map", "repr", "xrange", "cmp", "globals", "max", "reversed", "zip", "compile", "hasattr", "memoryview", "round", "__import__", "complex", "hash", "min", "set", "apply", "delattr", "help", "next", "setattr", "buffer", "dict", "hex", "object", "slice", "coerce", "dir", "id", "oct", "sorted", "intern"];
...
scope={"Node":Node,"Literal":Literal,"List":List,"Dict":Dict,"Index":Index,"Property":Property,"Expression":Expression,"Power":Power,"Ternary":Ternary,"Suite":Suite,"Assign":Assign,"Augment":Augment,"Import":Import,"For":For,"If":If,"Assert":Assert,"While":While,"Try":Try,"Invocation":Invocation,"Func":Func,"Lambda":Lambda,"Class":Class,"Module":Module,"keywords":keywords,"operator":operator,"newline":newline,"startline":startline,"dedent":dedent,"identifier":identifier,"indents":[0],"indent":0,"dedents":0,"brackets_count":0};
...
module.exports.bif_callable=bif_callable;
module.exports.bif_bytes=bif_bytes;
module.exports.bif_bytearray=bif_bytearray;
module.exports.bif_bool=bif_bool;
module.exports.bif_ascii=bif_ascii;
module.exports.bif_bin=bif_bin;
module.exports.bif_basestring=bif_basestring;
module.exports.bif_print=bif_print;
module.exports.bif_abs=bif_abs;
module.exports.bif_all=bif_all;
module.exports.bif_any=bif_any;
